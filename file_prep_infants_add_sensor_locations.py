...
This script reads in sensor locations and rotates the montage for plotting in MNE (from supine postition used during recording to upright/sitting position).
...
tasks = [task]
raw = utils.load_concatenate_data(dataset, subjects, task)
...
data_sensor_loc = [helmet.add_sensor_locations(d, dataset, paths.data) for d in raw]
