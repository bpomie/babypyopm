...
# Font sizes
AXIS_LABEL_SIZE      = 24     # panel B was 22
TICK_LABEL_SIZE      = 22    # panel B was 18
TITLE_SIZE           = 0     # panel B was 36
CBAR_TICK_LABEL_SIZE = 18     # panel B was 16
...
for ax, subj, evk in zip(axes, subjects, per_subject_avg):
    ...
    for axis in fig_joint.axes:
        ...
        if xl:
            axis.set_xlabel(xl, fontsize=AXIS_LABEL_SIZE, labelpad=8)
        if yl:
    ...
    ts_axis.set_xticks([0.0, 0.2, 0.4, 0.6])
    ...
    ax.set_title(subj, fontsize=10, pad=6,
