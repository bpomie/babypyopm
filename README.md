...
+ `montages` contains image files of sensor motanges: 📄 `*.png` 2D and 3D sensor layout plots
+ generated by: `000_file_prep_infants_add_sensor_locations.py`

## `results`

### `psd`
+ `psd` contains 📄 `*.png` wiht psd plots from *task* and *emptyroom* recordings
+ generated by: `000_file_prep_infants_add_sensor_locations.py`
